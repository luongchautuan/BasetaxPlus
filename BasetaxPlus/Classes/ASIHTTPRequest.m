...
{
    NSLog(@"Header: %@ Value: %@", header, value);
	if (!requestHeaders) {
...
- (NSString *)responseString
{
    ...
    NSLog(@"Response: %@", [[[NSString alloc] initWithBytes:[data bytes] length:[data length] encoding:[self responseEncoding]] autorelease]);
